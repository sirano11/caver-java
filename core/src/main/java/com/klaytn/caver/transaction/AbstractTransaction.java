...
abstract public class AbstractTransaction {
    ...
    public void fillTransaction() throws IOException{
        ...
        if(this.nonce.equals("0x") || this.chainId.equals("0x") || this.gasPrice.equals("0x")) {
            throw new RuntimeException("Cannot fill transaction data.(nonce, chainId, gasPrice), it can set these fields by calling a `Klay` instance to `klaytnCall` field through setKlaytnCall().");
        }
    }
